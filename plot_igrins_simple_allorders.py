...
# First written March 2021

# Last updated March 18 2021
##.     THIS CODE LETS YOU SKIP THE MODEL AND JUST PLOT ALL ORDERS OF THE SPECTRA
...
# 		temp_wave = temp_wave/1e4          # Angstroms to Microns
   ...
   #  #stoed cut off model 
	...
	plt.ylim(-4.8,4.5)
	# plt.xlim(1.673, 1.677)
	# plt.savefig('ABDOR_L5_BTsettlC_logg55_Teff_1200K_1600K.pdf')
	plt.show()
