...
# Plots IGRINS spectra with models with Sonora cloud free models (table with many columns)
# Written by Emily Lubar with many big chunks recycled from Eunkyu's original plotting code. 
# Parent code (code which came right before this): plot_igrins_simple.py made for BT Settl models
# March 2021
...
obs_file = 'SDCH_20201103_0048.spec_a0v.fits'           # File name of IGRINS data
...
for i in range(orders):
	...
	if i == 9:				#Allows you to chose one order to look at
